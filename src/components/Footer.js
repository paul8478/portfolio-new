...
export default function Footer() {
  return (
    <footer className="footer-body-main">
      <div className="footer-body">
        ...
        <div className="footer-links">
          <h3>Mails</h3>
          <a href="/about">spaulxofficial@gmail.com</a>
          <a href="/contact">somnathpaul626@gmail.com</a>
        ...
        <div className="footer-links">
          ...
          <a href="/faq">Education</a>
          <a href="/support">Programming Skills</a>
